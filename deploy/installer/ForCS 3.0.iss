...
Source: {#BuildDir}\Landis.Extension.Succession.ForC-v2.dll; DestDir: {#ExtDir}; Flags: replacesameversion
; Source: {#BuildDir}\Landis.Extension.Succession.ForC-v2.pdb; DestDir: {#ExtDir}; Flags: replacesameversion

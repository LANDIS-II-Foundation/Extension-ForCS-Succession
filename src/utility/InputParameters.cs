...
namespace Landis.Extension.Succession.ForC
{
        ...
        : IInputParameters
    {
        ...
        public Landis.Library.Parameters.Species.AuxParm<byte> FireTolerance { get { return fireTolerance; } }
        public Landis.Library.Parameters.Species.AuxParm<byte> ShadeTolerance { get { return shadeTolerance; } }
        ...
        public void SetOutputMap(InputValue<int> newValue)
        {
            ...
            if (newValue.Actual < 0)
                throw new InputValueException(newValue.String, "{0} must be >= 0.", newValue.String);

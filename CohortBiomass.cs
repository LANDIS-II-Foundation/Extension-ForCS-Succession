...
namespace Landis.Extension.Succession.ForC
{
        ...
        : Landis.Library.BiomassCohorts.ICalculator
    {
                                         ...
                                         int prevYearSiteMortality)
        {
            ...
            double potentialBiomass = Math.Max(1, maxBiomass - siteBiomass);
        ...
        private double ComputeGrowthMortality(ICohort cohort, ActiveSite site, int siteBiomass)
        {
            ...
            //Michaelis-Menton function (added by Scheller et all 2010):
            //if (B_AP > 1.0)
            //    M_BIO = maxANPP * B_PM;
            //else
                                            ...
                                            ActiveSite site)
        {
            ...
            double B_ACT = 0.0;
            if (siteCohorts != null)
                B_ACT = (double)Cohorts.ComputeNonYoungBiomass(siteCohorts);
